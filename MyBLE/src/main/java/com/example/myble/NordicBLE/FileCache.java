...
public class FileCache {
    ...
    public static boolean isExists(String address){
        for (DeviceBean deviceBean:mDevices) {
            if(deviceBean.getAddress().equalsIgnoreCase(address.trim())){
                return true;
            }
        }
        return false;
